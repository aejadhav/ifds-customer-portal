<template>
  <div class="page">
    ...
    <div v-if="!success" class="grid lg:grid-cols-3 gap-6">

      <!-- Left col: product / location / schedule -->
      ...
      <!-- Right col: payment mode + order summary + place order (sticky on desktop) -->
      <div class="lg:col-span-1 lg:sticky lg:top-24 lg:self-start space-y-4">
        ...
        <div class="card bg-gray-50 border-gray-200">
          ...
          <div v-if="form.quantity" class="space-y-1.5 text-sm">
          ...
          <p v-else class="text-sm text-gray-400">Enter a quantity to see the estimate.</p>
        </div>
    ...
    <!-- Success State -->
    <div v-if="success" class="card text-center py-10 space-y-3">
