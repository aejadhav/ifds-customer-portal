<template>
  <div class="page">
    ...
    <div v-if="!success" class="grid lg:grid-cols-3 gap-6">
      ...
      <!-- Right col: payment method + UPI/NEFT details + confirm button (sticky on desktop) -->
      <div class="lg:col-span-1 lg:sticky lg:top-24 lg:self-start space-y-4">
        ...
        <!-- UPI Detail -->
        <div v-if="paymentMode === 'upi'" class="card text-center space-y-2">
        ...
        <!-- NEFT detail -->
        <div v-if="paymentMode === 'neft'" class="card space-y-2 text-sm">
